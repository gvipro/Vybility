...
router.post('/', (req, res, next) => {
  ...
  .save()
  .then(_ => {
    redirectToQuestionnaire('success_msg', 'Questionnaire has been saved to database', req, res)
  })
  .catch(err => {
    console.log(err)
    redirectToQuestionnaire('error_msg', 'Error has occurred during saving', req, res)
  });
});
